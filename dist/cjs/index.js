...
class FNS {
  constructor(options) {
    ...
    this.getAddress = this.generateRawFunction(
      "getAddress",
      ["contracts"]
    );
    this.getContent = this.generateRawFunction(
      "getContent",
      ["contracts"]
    );
    this.getNameNode = this.generateRawFunction(
      "getNameNode",
      ["contracts"]
    );
    this.getAddrName = this.generateRawFunction(
      "getAddrName",
      ["contracts"]
    );
