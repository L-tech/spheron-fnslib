...
export declare const unnamedChildFuses: readonly [64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768];
...
export declare const unnamedUserSettableFuses: readonly [64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 524288, 1048576, 2097152, 4194304, 8388608, 16777216, 33554432, 67108864, 134217728, 268435456, 536870912, 1073741824, 2147483648];
...
type FuseType<Enum extends Record<string, number>, UnnamedTuple extends readonly number[], CustomFuses extends string = never> = {
    fuse: keyof Enum;
    options: {
...
export type ChildFuses = FuseType<typeof childFuseEnum, typeof unnamedChildFuses, 'CAN_DO_EVERYTHING'>;
export type ParentFuses = FuseType<typeof parentFuseEnum, typeof unnamedParentFuses>;
export type FullParentFuses = FuseType<typeof fullParentFuseEnum, typeof unnamedParentFuses>;
export type UserSettableFuses = FuseType<typeof userSettableFuseEnum, typeof unnamedUserSettableFuses>;
