...
export declare const multicallWrapper: {
    raw({ contracts }: FNSArgs<'contracts'>, transactions: TransactionRequest[], requireSuccess?: boolean): Promise<{
        to: string;
        data: string;
    }>;
    decode({ contracts, provider }: FNSArgs<'contracts' | 'provider'>, data: string, transactions: TransactionRequest[]): Promise<{
        success: boolean;
        returnData: string;
        0: boolean;
        1: string;
