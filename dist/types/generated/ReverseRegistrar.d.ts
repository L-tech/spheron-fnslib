...
export interface ReverseRegistrarInterface extends Interface {
    ...
    getFunction(nameOrSignatureOrTopic: 'claim' | 'claimForAddr' | 'claimWithResolver' | 'controllers' | 'defaultResolver' | 'fns' | 'node' | 'owner' | 'renounceOwnership' | 'setController' | 'setDefaultResolver' | 'setName' | 'setNameForAddr' | 'transferOwnership'): FunctionFragment;
...
export type DefaultResolverChangedEventFilter = TypedEventFilter<DefaultResolverChangedEvent>;
